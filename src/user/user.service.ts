...
export class UserService {
  constructor(@InjectRepository(User) private userRepository: Repository<User>,
              @InjectRepository(Profile) private profileRepository: Repository<Profile>, private roleService: RoleService,) {
  }
  ...
  async create(dto: UserRegistrationDto, rol: string = 'ADMIN') {
    ...
    await this.profileRepository.save({user,firstName:dto.name})
